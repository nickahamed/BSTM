...
```{r, fig.width="8in", echo=FALSE, message=F, warning=F, fig.align='center'}
...
```{r, fig.width="8in", echo=FALSE, message=F, warning=F,  fig.align='center',include=FALSE}
...
```{r, fig.width="3in", echo=FALSE, message=F, warning=F,  fig.align='center',include=FALSE}
...
```{r, fig.width="8in", echo=FALSE, message=F, warning=F,  fig.align='center'}
knitr::include_graphics("figures/pollster_bias.png")
```
...
```{r, fig.width="8in", echo=FALSE, message=F, warning=F, fig.align='center'}
knitr::include_graphics("figures/pollster_cycle.png")
```
...
```{r, fig.width="3in", echo=FALSE, message=F, warning=F,  fig.align='center'}
knitr::include_graphics("figures/univ_bias.png")
```
...
```{r, fig.width="8in", echo=FALSE, message=F, warning=F,  fig.align='center'}
knitr::include_graphics("figures/univ_cycle.png")
```
